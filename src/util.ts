...
export function convert(content: string, ignore_variables?: boolean): string {
    return content.replace(
        /\{__(name|email|author|link|date|delete|camelCaseName|pascalCaseName|snakeCaseName|kebabCaseName|lowerDotCaseName|fileNamePrefix|fileNamePrefixSnakeUpper|namespaceStart|namespaceEnd|moduleNamePascal|cppInheritInterface)__\.?([^{}]*)\}/g,
